...
## Extracting keyword + words of the same sentence before and after (need to figure out how to deal with multiple mentions in the same row)
```{r extract_keyword}
# Choose a  keyword
...
print(word_document_freq)
```
```{r inverse_document_frequency}
#modify to add more documents
