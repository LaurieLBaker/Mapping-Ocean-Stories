...
```{r, echo=FALSE, out.width=400, fig.align='center', fig.alt="Scallop Dragging"}
...
To listen to Island Institute’s podcast visit [https://www.islandinstitute.org/stories/podcast/](https://www.islandinstitute.org/stories/podcast/)
To listen to Coastal Conversations visit [https://seagrant.umaine.edu/coastal-conversations-radio-program/](https://seagrant.umaine.edu/coastal-conversations-radio-program/)
For more information about Maine Sound + Story visit [www.mainesoundandstory.com](www.mainesoundandstory.com)
To explore The First Coast’s exhibits visit [www.thefirstcoast.org](www.thefirstcoast.org)
To explore the spatial data visit: [https://mos-data-coagis.hub.arcgis.com/](https://mos-data-coagis.hub.arcgis.com/).
