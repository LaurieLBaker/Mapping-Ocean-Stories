...
knitr::include_graphics("slides/figs/fishing_what.png")
```
...
```{r chile-fishing-map, echo = FALSE, out.width="95%", fig.align="center", fig.alt = "Map of fishing locations in Chile"}
pal <- colorNumeric(
  palette = "Oranges",
...
(start_position_map <- leaflet(data = palangre87_97) %>%
   setView(lng = 1.382203, lat = -61.051992, zoom = 4) %>%
