---
title: "Connecting Oceans, Communities, and Data: A Journey from Marine Biology to Data Science"
...
## Returning to Maine and Mapping Ocean Stories
...
#### `r icons::fontawesome("graduation-cap")` Collaboration with the Island Institute, Maine Sea Grant, The First Coast, and College of the Atlantic.
...
### `r icons::fontawesome("headphones")` March 2023 received a grant to further develop two key outputs: Maine Sound + Story and the Maine Historical Fisheries Atlas.
